...
% ----------------------------
utcDT = datetime(2026,6,21,3,0,0,"TimeZone","UTC");                          % (year, month, day, hr, min, second) - summer solstice 21st of June (~4:30 sunrise - for this location in summer UTC = LOCAL - 1)
