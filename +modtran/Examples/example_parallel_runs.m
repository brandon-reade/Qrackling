...
json_root = fullfile(repo_root, "+modtran","JSON_Cases",...
    "HOGS_sun_Jan3_8am_5kmvis_300to10000_zenstep10_azistep30");
...
collect_dir = fullfile(repo_root,"+modtran","Data","HOGS", filename);    % choose where to collect the files of interest); 
