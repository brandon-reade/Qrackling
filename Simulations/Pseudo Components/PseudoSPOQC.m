function HubSat = PseudoSPOQC(Wavelength,options)
%SPOQC Construct a model of the Quantum Comms hub satellite
arguments
     Wavelength (1,1) double {mustBePositive}     % CHANGED: allow any wavelength (nm)
...
% removed wavelength restriction assertion seen in standard SPOQC
