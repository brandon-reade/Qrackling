...
% Things to implement:
%   - Clock shift (so lower time gating = more vulnerable)
%       - I think Doppler shift already done (at least for spatial)
%       - Turbulence
...
QKDsystems = struct( ...
    'Wavelength', {1550, 2036, 2050}, ...                                   % in nanmometers such as: 850, 1550, 2140, 2210, 3400
    'DetectorPreset', { 'SingleQuantum_specs_telecom', ...                  % dead-time according to: https://doi.org/10.48550/arXiv.2103.14086 for 1550nm
                        ...
                        'SingleQuantum_specs_2um'}, ... %mod_SNSPD_NbTiN_2um
    'txDiam', {Transmitter_Telescope_Diameter/1.32, Transmitter_Telescope_Diameter/1.006, Transmitter_Telescope_Diameter},...     % transmitter telescope diameter (0.08m for SPOQC)
    ...
    'TimeGateWidth', {130E-12, 130E-12, 130E-12}...
                        );
