...
% Date: 17/03/2026
% Comparison of a standard BB84 pass: visibility and wavelength compared
...
% 500m vis directory
vis500m_dir = fullfile(repo_root, 'Examples', 'Data', ...                              
    'atmospheric transmittance', 'raw modtran data',...
    'HOGS_WinterClear_Lunar_angles', 'HOGS_Winter-500mVis',...
    'moon_jan3rd_2026_1am_100to10000nm_full');  

% 1k vis directory
vis1k_dir = fullfile(repo_root, 'Examples', 'Data', ...                              
    'atmospheric transmittance', 'raw modtran data',...
...
%10k vis directory
vis10k_dir = fullfile(repo_root, 'Examples', 'Data', ...                              
    'atmospheric transmittance', 'raw modtran data',...
