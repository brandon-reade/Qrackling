        ...
        function obj = Detector( ...
            ...
            arguments
                ...
                options.Preset {mustBeMember(options.Preset, { ...
                    ...
                    'SNSPD_NbTiN_2um',...                                   % based on 10.1364/PRJ.437834
                    'SingleQuantum_specs_2um',...                           % based on Single Quantum spec sheet
                    'SingleQuantum_specs_telecom',...
                    'mod_QuantumOpus1550_RoomTempAmplifier',...             % modified detectors for simulation purposes...
                    'mod_SNSPD_NbTiN_2um',...
                    'mod_SingleQuantum_specs_2um',...
                    'mod_SingleQuantum_specs_3um',...
                    'none'})} = 'none'
